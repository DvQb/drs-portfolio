...
const mdCardStyle =  " bg-white dark:bg-[#2a2a2a] shadow-xl h-[580px] w-[300px] lg:w-[550px] lg:h-[650px] rounded-2xl my-auto text-textPrimary grid gap-3 justify-end my-8 overflow-hidden hover:scale-105  ";
...
const Card = ({url, image, title , text, icon1,icon2,icon3,icon4}) => {
    ...
    return (
                    ...
                    <div onClick={handleClick} className={mdCardStyle} >
                        ...
                        <h3 className="mx-auto text-lg md:text-xl lg:text-2xl text-nowrap px-4 w-auto mt-3">{title}</h3>
...
const Cards = () => {
    return (
        <div className="grid justify-center mb-14">
            ...
            <h3 className="justify-self-center text-2xl md:text-3xl mb-5 lg:mb-8">PROJECTS</h3>  
            ...
            <section className=" grid md:grid-cols-2 lg:flex lg:justify-center lg:flex-wrap lg:gap-20 lg:mx-12 gap-12 m-auto py-8 mb-10 max-w-[1440px] ">
                ...
                <Card
                    ...
                    text="This site was created from a Front End Mentor exercise. The project included HTML, CSS, JS, and Tailwind. During development, I learned how to use Tailwind CSS and how to use it for responsive design."
...
{/*                                 
                    ...
                    image={extensionList}
                    title="Front end mentor"
                    text="This extensions list was created from a Front End Mentor exercise. The project included HTML, CSS, React, Json, and Tailwind. During development, I learned how to create cards using useState and taking the data from a Json file."
                    icon1={<FontAwesomeIcon icon={ faHtml5 }  className={iconStyles}/> }
