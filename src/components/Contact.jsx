        ...
        <section className="my-14" id="contact">
            ...
            <div className="grid md:gap-8 lg:flex py-14 mb-6">
                ...
                <aside className="grid  items-center gap-16 lg:w-[40%] pt-12 h-full  lg:pr-10">
                    ...
                    <span className="text-xl md:text-2xl text-center lg:text-start font-semibold">davidresendiz753@gmail.com</span>
                    <span className="text-xl md:text-2xl text-center lg:text-start font-semibold">+52 4439330526</span>
